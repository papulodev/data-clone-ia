...
import { ArrowDown, Award, Cable, CircleDollarSign, File, Lightbulb, RefreshCcw, Scale, Trophy, UnfoldHorizontal } from "lucide-react";
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {!comparacion ? (
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-8 items-center">
              ...
              <div className="flex flex-col items-center py-8">
                <div
                  ...
                  <div className={clsx(`w-full h-[${comparacion.similitud.porcentaje}%]`, {
            ...
            {/* Diferencias de Clúster */}
            <div className="glass-panel p-8 rounded-[2rem]">
              <div className="flex items-center gap-3 mb-3">
                <File className="w-5 h-5 text-error" />
                <h3 className="text-xl font-headline font-bold text-white">Diferencias de Clúster</h3>
              </div>
