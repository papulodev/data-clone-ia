    ...
    <div className="flex-1 p-8 overflow-y-auto">
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="glass-panel ghost-border rounded-2xl p-8 md:p-12 group shadow-[0_40px_60px_-5px_rgba(42,28,132,0.05)] relative overflow-hidden">
          ...
          <div className="relative flex flex-col justify-center lg:flex-row items-center gap-6">
            {/* Avatar */}
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-2 mt-2">
                <span className="px-3 py-1 rounded-lg bg-secondary-container/40 ghost-border text-sm font-label text-secondary">
                  {clone.edad} años
                </span>
                <span className="px-3 py-1 rounded-lg bg-secondary-container/40 ghost-border text-sm font-label text-secondary">
                  {clone.genero}
...
function StatCard({
  ...
  return (
    <div className="glass-panel ghost-border rounded-2xl p-6 flex flex-col justify-between items-center hover:scale-[1.02] transition-transform duration-300">
      ...
      <p className="text-2xl md:text-3xl font-manrope font-bold text-on-surface">{value}</p>
    </div>
  );
}
